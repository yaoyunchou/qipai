"""执行 sql/supabase/07-expense-voided.sql。用法: python -m scripts.apply_expense_void"""
import sys
...
SQL_FILE = ROOT.parent.parent / "sql" / "supabase" / "07-expense-voided.sql"
