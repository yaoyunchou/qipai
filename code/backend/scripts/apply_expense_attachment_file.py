"""执行 sql/supabase/06-expense-attachment-file.sql。用法: python -m scripts.apply_expense_attachment_file"""
import sys
...
SQL_FILE = ROOT.parent.parent / "sql" / "supabase" / "06-expense-attachment-file.sql"
...
def main() -> None:
    ...
    try:
        ...
        conn.close()
    print("已添加 file_path 列。若库中仍有 data_base64 数据，请运行: python -m scripts.migrate_expense_attachments")
